...
pForm._gfnSetEditMsClear = function (oEdt)
{
	...
	oBtn.set_icon("URL('theme://images/btn_del.png')");
...
pForm.gfnGetDLLPath = function(sFileName)
{
	...
	// 웹 접속
		...
		strpath = system.convertRealPath("%USERAPP%\\Component\\edupack_nexacro\\" + sFileName);
	}
trace(strpath);	
...
// 	}
	...
	alert("navigatorFullName : " + navigatorFullName);
