(function()
{
    return function()
    {
        ...
        this.Form_onload = function(obj,e) // 폼의 컴포넌트들이 다 열릴때
        {
        	...
        	this.div_search.form.cal_to.set_value(sYear+sMonth+sDay); // 오늘 날짜
        ...
        this.btn_search_onclick = function(obj,e)
        {
            ...
            var sParam    = "";
            var sCallBack = "fn_callback";
        	this.transaction(sSvcID, sURL, sInDs, sOutDs, sParam, sCallBack, false); // false는 동기방식


        	// Select Employees Data 사원정보
            var sDeptCode = this.ds_dept.getColumn(this.ds_dept.rowposition, "CODE");	 // 부서정보를 가져온다음, 선택된 데이터셋 정보를 파라미터로 넘겨줌
        ...
        {
        	var nRow = this.ds_emp.addRow(); // 데이터셋의 레코드를 하나 추가
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_search.form.cal_from.addEventHandler("onchanged",this.div_search_cal_from_onchanged,this);
