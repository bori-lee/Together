(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"70\"/><Column size=\"70\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\"업무명\"/><Cell col=\"1\" colspan=\"2\" text=\"참여기간\"/><Cell col=\"3\" rowspan=\"2\" text=\"고객사\"/><Cell col=\"4\" rowspan=\"2\" text=\"근무회사\"/><Cell col=\"5\" rowspan=\"2\" text=\"역할\"/><Cell row=\"1\" col=\"1\" text=\"FROM_DT\"/><Cell row=\"1\" col=\"2\" text=\"TO_DT\"/></Band><Band id=\"body\"><Cell text=\"bind:TASK\"/><Cell col=\"1\" text=\"bind:FROM_DT\"/><Cell col=\"2\" text=\"bind:TO_DT\"/><Cell col=\"3\" text=\"bind:CUSTOMER_NAME\"/><Cell col=\"4\" text=\"bind:COMPANY\"/><Cell col=\"5\" text=\"bind:POSITION\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta02_01_00_01_02","310","389","29","14",null,null,null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_text("H 28");
            obj.set_cssclass("sta_WF_GTxt");
            this.addChild(obj.name, obj);

            obj = new Static("sta00_01_00_01_00_02","340","381","9","28",null,null,null,null,null,null,this);
            obj.set_taborder("20");
            obj.set_cssclass("sta_WF_GLineV");
            this.addChild(obj.name, obj);
