(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Calendar("Calendar00","20","73","180","28",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_locale("");
            obj.set_value("20170101");
            this.addChild(obj.name, obj);

            obj = new Calendar("cal_trailing","20","267","200","220",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_locale("");
            ...
            obj = new Radio("Radio00","240","136","216","28",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Grid("Grid00","518","427","472","154",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_binddataset("ds_day");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"100\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/></Columns><Rows><Row size=\"28\" band=\"head\"/><Row size=\"28\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\"date\"/><Cell col=\"1\" colspan=\"3\" text=\"color\"/><Cell row=\"1\" col=\"1\" text=\"text\"/><Cell row=\"1\" col=\"2\" text=\"background\"/><Cell row=\"1\" col=\"3\" text=\"border\"/></Band><Band id=\"body\"><Cell text=\"bind:date\" displaytype=\"date\" textAlign=\"center\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"1\" text=\"bind:text_color\" edittype=\"text\"/><Cell col=\"2\" text=\"bind:back_color\" edittype=\"text\"/><Cell col=\"3\" text=\"bind:border_color\" edittype=\"text\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static00","10","234","296","28",null,null,null,null,null,null,this);
            obj.set_taborder("24");
            ...
            obj = new Static("Static03","10","136","276","30",null,null,null,null,null,null,this);
            obj.set_taborder("26");
            ...
            obj = new Radio("rdo_tra","304","234","122","28",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_rowcount("-1");
            ...
            obj = new Static("Static06","11","512","408","28",null,null,null,null,null,null,this);
            obj.set_taborder("29");
            obj.set_text(" Localization (Prop. dateformat, editformat, local)");
            obj.set_cssclass("sta_WF_TypeTitle");
            this.addChild(obj.name, obj);

            obj = new Static("Static09","19","578","94","28",null,null,null,null,null,null,this);
            obj.set_taborder("30");
            obj.set_text("long date");
            obj.set_cssclass("sta_WF_LabelTxt12");
            this.addChild(obj.name, obj);

            obj = new Static("Static10","19","614","94","28",null,null,null,null,null,null,this);
            obj.set_taborder("31");
            ...
            obj = new Static("Static11","20","73","104","28",null,null,null,null,null,null,this);
            obj.set_taborder("32");
            obj.set_text("Today");
            obj.set_positionstep("1");
            obj.set_cssclass("sta_WF_LabelTxt12");
            ...
            obj = new Static("Static12","20","106","104","28",null,null,null,null,null,null,this);
            obj.set_taborder("33");
            ...
            obj = new Calendar("cal_type","20","171","180","28",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_locale("");
            obj.set_value("20210901");
            obj.set_type("normal");
            ...
            obj = new Static("sta00","10","0","120","43",null,null,null,null,null,null,this);
            obj.set_taborder("35");
