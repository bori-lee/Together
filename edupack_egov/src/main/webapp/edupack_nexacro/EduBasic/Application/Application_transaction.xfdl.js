(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btn_retrieve",null,"2","84","30","265",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("Retrieve");
            obj.set_cssclass("btn_WF_CRUD");
            this.addChild(obj.name, obj);

            obj = new Button("btn_add",null,"2","80","30","180",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("Add");
            obj.set_cssclass("btn_WF_CRUD");
            this.addChild(obj.name, obj);

            obj = new Button("btn_del",null,"2","80","30","95",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("Delete");
            obj.set_cssclass("btn_WF_CRUD");
            this.addChild(obj.name, obj);

            obj = new Button("btn_save",null,"2","80","30","10",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("Save");
            obj.set_cssclass("btn_WF_CRUD");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("grd_list","10","94",null,null,"400","10",null,null,null,null,this);
            obj.set_taborder("6");
