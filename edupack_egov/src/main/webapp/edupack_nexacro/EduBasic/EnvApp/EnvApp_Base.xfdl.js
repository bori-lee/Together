(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("edt_appVar","110","70","190","28",null,null,null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_readonly("true");
            obj.set_positionstep("1");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn00","710","28","120","21",null,null,null,null,null,null,this);
            obj.set_taborder("38");
            obj.set_text("btn00");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("msk00","725","73","90","21",null,null,null,null,null,null,this);
            obj.set_taborder("39");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1038,650,this,
                ...
                p.Static05.set_cssclass("sta_WF_TypeTitle");
                ...
                p.edt_appVar.move("110","70","190","28",null,null);

                p.Static07.set_taborder("25");
                p.Static07.set_text(" Application Datasets");
                p.Static07.set_cssclass("sta_WF_TypeTitle");
                ...
                p.Static22.set_cssclass("sta_WF_TypeTitle");
                ...
                p.Static24.set_cssclass("sta_WF_TypeTitle");
                ...
                p.Static00_00_00.set_cssclass("sta_WF_FrmTitle");
                p.Static00_00_00.set_positionstep("-1");
                p.Static00_00_00.move("10","0","250","28",null,null);

                p.btn00.set_taborder("38");
                p.btn00.set_text("btn00");
                p.btn00.move("710","28","120","21",null,null);

                p.msk00.set_taborder("39");
                p.msk00.move("725","73","90","21",null,null);
            	}
            );
