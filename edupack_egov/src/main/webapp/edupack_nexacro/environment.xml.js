if (nexacro.Environment)
{
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("SvcXpushURL", "JSP", "http://172.10.14.142f:8080/jspSampleN/", "session", null, "", "0", "0");
        nexacro._addService("SvcUrl2", "JSP", "http://172.10.14.142:8088/edupack_egov/", "session", null, "", "0", "0");
