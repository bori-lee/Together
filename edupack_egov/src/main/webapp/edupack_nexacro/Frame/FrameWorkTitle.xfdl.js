(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnMyMenu","20","4","17","26",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_visible("true");
            obj.set_cssclass("btn_WT_Mymnu");
            this.addChild(obj.name, obj);

            obj = new Button("btnSel",null,"5","50","28","275",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("조회");
            ...
            obj = new Button("btnAdd",null,"5","50","28","220",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("입력");
            obj.set_cssclass("btn_WF_CRUD");
            obj.set_visible("false");
            ...
            obj = new Button("btnSav",null,"5","50","28","0",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("저장");
            obj.set_cssclass("btn_WF_CRUD");
            obj.set_visible("false");
            ...
            obj = new Button("btnDel",null,"5","50","28","165",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("삭제");
            obj.set_cssclass("btn_WF_CRUD");
            obj.set_visible("false");
            ...
            obj = new Button("btnExl",null,"5","50","28","110",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("엑셀");
            obj.set_cssclass("btn_WF_CRUD");
            obj.set_visible("false");
            ...
            obj = new Button("btnPrt",null,"5","50","28","55",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("출력");
            obj.set_cssclass("btn_WF_CRUD");
            obj.set_visible("false");
            ...
            obj = new Static("staTitle","41","5","560","26",null,null,null,null,null,null,this);
            obj.set_taborder("7");
        ...
        */
        this.fnSetMyMenuBtn = function ()
        {
        	...
        	if( nRow < 0 ){
        		this.btnMyMenu.set_cssclass("btn_WT_Mymnu");
        	}
        	else{
        		this.btnMyMenu.set_cssclass("btn_WT_MymnuS");
        	}
        };
        ...
        */
        this.btnMyMenu_onclick = function(obj,e)
        {
        	...
        	if( sBtnCss == "btn_WT_MymnuS") bIsMymenu = true;

        	var objDs     = this.objApp.gdsMyMenu;
        	var objMenuDs = this.objApp.gdsMenu;

        	objDs.set_enableevent(false);
        	this.objApp.gvLeftFrame.form.grdMyMenu.set_enableredraw(false);
        	...
        	this.objApp.gvLeftFrame.form.grdMyMenu.set_enableredraw(true);
