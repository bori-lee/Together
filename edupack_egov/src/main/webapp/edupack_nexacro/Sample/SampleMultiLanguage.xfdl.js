(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnLang","37","421","48","28",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("버튼");
            ...
            obj = new Static("staLang","182","421","63","28",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("스테틱");
            obj.getSetter("uWord").set("comp.static");
            this.addChild(obj.name, obj);

            obj = new CheckBox("chkLang","345","421","100","28",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("체크 버튼");
            obj.getSetter("uWord").set("comp.check");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid00","10","507",null,"120","10",null,null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj = new Tab("Tab00","10","685","490","135",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_tabindex("0");
            ...
            obj = new Static("Static02","10","335","91","28",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("Language");
            obj.set_cssclass("sta_WF_Title13");
            this.addChild(obj.name, obj);

            obj = new Combo("cboLanguage","102","335","150","28",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            ...
            obj = new ImageViewer("imgLang","538","421","50","28",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_image("URL(\"theme://images/btn_TF_Normal_D.png\")");
            obj.getSetter("uWord").set("true");
            obj.set_stretch("fit");
            this.addChild(obj.name, obj);

            obj = new Button("btnImage","598","421","84","28",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("이미지 확인");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta03","10","50",null,"260","10",null,null,null,null,null,this);
            obj.set_taborder("10");
            ...
            obj = new Static("Static01","10","388","218","28",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("1) Button, Static, CheckBox");
            obj.set_cssclass("sta_WF_Title13");
            this.addChild(obj.name, obj);

            obj = new Static("Static03","511","388","178","28",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("2)  ImageViewer");
            obj.set_cssclass("sta_WF_Title13");
            this.addChild(obj.name, obj);

            obj = new Static("Static00","10","474","178","28",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("3)  Grid");
            obj.set_cssclass("sta_WF_Title13");
            this.addChild(obj.name, obj);

            obj = new Static("Static04","10","652","178","28",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_text("4)  Tab, Tab page, Div");
            obj.set_cssclass("sta_WF_Title13");
            this.addChild(obj.name, obj);

            obj = new Div("divLang","510","685","480","135",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_text("div00");
            ...
            obj = new Static("Static05","10","845","288","28",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_text("5)  Script내 용어 다국어 처리(팝업 Title)");
            obj.set_cssclass("sta_WF_Title13");
            this.addChild(obj.name, obj);

            obj = new Button("btnPopup","10","878","120","28",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_text("모달팝업");
            obj.getSetter("uWord").set("popup.modal");
            this.addChild(obj.name, obj);

            obj = new Calendar("cal00","115","6","131","34",null,null,null,null,null,null,this);
            obj.set_taborder("18");
            this.addChild(obj.name, obj);

            obj = new Edit("edt00","672","324","236","64",null,null,null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_rtl("true");
            this.addChild(obj.name, obj);
            // Layout Functions
