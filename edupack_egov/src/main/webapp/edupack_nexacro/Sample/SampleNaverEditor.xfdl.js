(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new WebBrowser("webEditor","10","105",null,"450","490",null,null,null,null,null,this);
            obj.set_taborder("2");
            this.addChild(obj.name, obj);

            obj = new Button("btn00",null,"325","30","30","460",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_cssclass("btn_WF_ShuttleL");
            this.addChild(obj.name, obj);

            obj = new Button("btn01",null,"285","30","30","460",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_cssclass("btn_WF_ShuttleR");
            this.addChild(obj.name, obj);

            obj = new TextArea("txt00",null,"105","440","448","10",null,null,null,null,null,this);
            obj.set_taborder("5");
