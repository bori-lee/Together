(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new WebBrowser("Webbrowser00","10","155",null,null,"10","10",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_url("http://");
            this.addChild(obj.name, obj);

            obj = new Button("Button01",null,"120","250","30","10",null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj.set_taborder("2");
            obj.set_text("ClipReport");
            obj.set_cssclass("sta_WF_FrmTitle");
            this.addChild(obj.name, obj);

            obj = new Static("sta03","10","50",null,"60","10",null,null,null,null,null,this);
            obj.set_taborder("3");
