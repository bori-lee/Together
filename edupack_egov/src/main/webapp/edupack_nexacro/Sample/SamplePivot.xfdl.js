(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("Button00","10","645","130","28",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("pivot 생성");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid00","10","678",null,"280","10",null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Static("sta03","10","50",null,"590","10",null,"980",null,null,null,this);
            obj.set_taborder("3");
