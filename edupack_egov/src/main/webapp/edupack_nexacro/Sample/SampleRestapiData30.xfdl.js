(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta01","10","50",null,"50","10",null,null,null,null,null,this);
            obj.set_taborder("5");
        ...
        *  @FileName 	SampleRestapiData30.xfdl
        *  @Creator 	Education
        ...
        */
        ...
        {
        	this.transaction("Select","http://localhost:8088/edupack_egov/edu/edupack_jsp/restapi_data30.jsp","","Dataset00=output","busRouteId=" +  this.edtBusRouteId.value,"fn_call");
        };
