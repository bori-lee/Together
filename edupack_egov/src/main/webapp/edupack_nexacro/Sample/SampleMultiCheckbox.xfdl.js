(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divCheckbox","10","255","540","278",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Div00");
            ...
            obj = new Static("Static00","10","50",null,"170","10",null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Button("btnSetValue","570","288","90","28",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("setValue");
            this.addChild(obj.name, obj);

            obj = new Button("btnGetValue","570","354","90","28",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("getValue");
            this.addChild(obj.name, obj);

            obj = new Button("btnInit","570","255","90","28",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("init");
            this.addChild(obj.name, obj);

            obj = new Edit("edtGetValue","665","354","346","28",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Button("btnSetValue00","570","321","90","28",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("setValue");
            this.addChild(obj.name, obj);

            obj = new Edit("Edit00","665","288","346","28",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_enable("false");
            obj.set_value("userproperty사용");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSetValue","665","321","346","28",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_enable("false");
            obj.set_value("this.Dataset01,\"code\",\"name\"");
            this.addChild(obj.name, obj);

            obj = new Button("btnRequiredTrue","665","255","106","28",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("RequiredTrue");
            this.addChild(obj.name, obj);

            obj = new Button("btnRequiredFalse","776","255","106","28",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("RequiredFalse");
            this.addChild(obj.name, obj);

            obj = new Button("btnGetText","570","387","90","28",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("getText");
            this.addChild(obj.name, obj);

            obj = new Edit("edtGetValue00","665","387","346","28",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_enable("false");
            this.addChild(obj.name, obj);
