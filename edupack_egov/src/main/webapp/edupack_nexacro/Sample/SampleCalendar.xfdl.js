(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta03","10","50",null,"150","10",null,null,null,null,null,this);
            obj.set_taborder("30");
            obj.set_text("1. Div를 생성하고 url 속성에\r\r\r\n    기간달력 : \"Cmm::CmmCalFromTo.xfdl\"\r\r\r\n    월력 : \"Cmm::CmmCalMM.xfdl\" 을 지정한다.\r\r\r\n\r\n2. Calendar 방식의 월달력\r\n    Calendar user property에 uCalType 를 추가하고 값을 MM 으로 설정한다.");
            ...
            obj = new Static("Static02_00","0","225","218","28",null,null,null,null,null,null,this);
            obj.set_taborder("33");
            obj.set_text("1) 기간달력");
            obj.set_cssclass("sta_WF_Title13");
            this.addChild(obj.name, obj);
        ...
        */
        ...
        this.edtSetTo_onchanged = function(obj,e)
        {

        };

        this.cal01_onchanged = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.edtSetTo.addEventHandler("onchanged",this.edtSetTo_onchanged,this);
            ...
            this.cal01.addEventHandler("onchanged",this.cal01_onchanged,this);
        };
