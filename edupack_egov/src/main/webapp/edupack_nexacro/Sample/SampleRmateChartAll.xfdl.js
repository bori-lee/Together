(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta03","10","60",null,"90","10",null,null,null,null,null,this);
            obj.set_taborder("5");
            ...
            obj = new Static("Static00","10","162","178","28",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("1) Line ");
            obj.set_cssclass("sta_WF_Title13");
            this.addChild(obj.name, obj);

            obj = new Static("Static01","515","162","178","28",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("2) Bar");
            obj.set_cssclass("sta_WF_Title13");
            this.addChild(obj.name, obj);

            obj = new Static("Static02","10","582","178","28",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("3) Column");
            obj.set_cssclass("sta_WF_Title13");
            this.addChild(obj.name, obj);

            obj = new Static("Static03","515","582","178","28",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("4) Pie");
            obj.set_cssclass("sta_WF_Title13");
            this.addChild(obj.name, obj);

            obj = new Button("btnChangData","899","587","110","28",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("Data 변경");
            this.addChild(obj.name, obj);

            obj = new Button("btnChangLayout","784","587","110","28",null,null,null,null,null,null,this);
            obj.set_taborder("11");
