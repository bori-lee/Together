(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grdMessage","10","238",null,null,"10","10",null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_binddataset("gdsMessage");
            obj.set_autofittype("col");
            obj.set_autoenter("select");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"180\"/><Column size=\"300\"/><Column size=\"300\"/><Column size=\"80\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"Msg Id\"/><Cell col=\"1\" text=\"Msg Text\"/><Cell col=\"2\" text=\"Msg Text EN\"/><Cell col=\"3\" text=\"Msg Type\"/></Band><Band id=\"body\"><Cell text=\"bind:MSG_ID\" edittype=\"readonly\" editautoselect=\"true\"/><Cell col=\"1\" text=\"bind:MSG_TEXT\" editautoselect=\"true\"/><Cell col=\"2\" text=\"bind:MSG_TEXT_EN\" editautoselect=\"true\"/><Cell col=\"3\" text=\"bind:MSG_TYPE\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Button("btn00",null,"205","90","28","105",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("Alert");
            this.addChild(obj.name, obj);

            obj = new Button("btn01",null,"205","90","28","10",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("Confirm");
            this.addChild(obj.name, obj);

            obj = new Button("btnGoogle",null,"0","90","28","10",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("구글번역기");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta01","10","50",null,"130","10",null,"980",null,null,null,this);
            obj.set_taborder("6");
