(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("stc","10","50",null,"170","10",null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Div("divMultCombo","10","288","202","28",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("Div00");
            ...
            obj = new Button("btnGetValue","10","321","106","28",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("get Value");
            this.addChild(obj.name, obj);

            obj = new Edit("edtGetValue","121","321","245","28",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            this.addChild(obj.name, obj);

            obj = new Button("btnSetValue","10","387","106","28",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("set Value");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSetValue","121","387","245","28",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            this.addChild(obj.name, obj);

            obj = new Button("btnGetText","10","354","106","28",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("get Text");
            this.addChild(obj.name, obj);

            obj = new Edit("edtGetText","121","354","245","28",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            this.addChild(obj.name, obj);

            obj = new Button("btnInit","322","288","100","28",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            ...
            obj = new Static("Static03","10","255","198","28",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("1) 멀티콤보 사용방법");
            obj.set_cssclass("sta_WF_Title13");
            this.addChild(obj.name, obj);

            obj = new Button("btnRequiredTrue","10","420","106","28",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("Required True");
            this.addChild(obj.name, obj);

            obj = new Button("btnRequiredFalse","121","420","106","28",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("Required False");
            this.addChild(obj.name, obj);

            obj = new Div("divMultCombo00","499","288","202","28",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("Div00");
            obj.set_url("Cmm::CmmMultiCombo.xfdl");
            obj.getSetter("combocodecolumn").set("code");
            ...
            obj = new Static("Static04","499","255","410","28",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_text("2) 전체선택/해제     userproperty -> allcheck 추가 후 true");
            obj.set_cssclass("sta_WF_Title13");
            this.addChild(obj.name, obj);

            obj = new Div("div00","499","321","224","28",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_text("div00");
            obj.set_url("Cmm::CmmMultiCombo.xfdl");
            ...
            obj = new Button("btnSetData","217","288","100","28",null,null,null,null,null,null,this);
            obj.set_taborder("16");
