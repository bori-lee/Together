(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new WebBrowser("webBrowResult","10","158",null,null,"10","9",null,null,null,null,this);
            obj.set_taborder("0");
            this.addChild(obj.name, obj);

            obj = new Button("btn00",null,"125","120","28","15",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("10개추가");
            this.addChild(obj.name, obj);

            obj = new Static("sta00","10","0","331","30",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("Web Browsser Scroll");
            obj.set_cssclass("sta_WF_FrmTitle");
            this.addChild(obj.name, obj);

            obj = new Static("sta01","10","50",null,"70","10",null,null,null,null,null,this);
            obj.set_taborder("3");
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.ds_document.addEventHandler("onload",this.ds_document_onload,this);
        };
