(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta01","10","50",null,"110","10",null,null,null,null,null,this);
            obj.set_taborder("7");
            ...
            obj = new Grid("grdMessage","10","168",null,null,"10","10",null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Edit("edtFrom",null,"0","226","28","295",null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Button("btnChange",null,"0","49","28","241",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("전환");
            this.addChild(obj.name, obj);

            obj = new Edit("edtTo",null,"0","226","28","10",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_displaynulltext("pleaseEnter");
            this.addChild(obj.name, obj);

            obj = new Combo("cboGubn",null,"0","126","28","526",null,null,null,null,null,this);
            obj.set_taborder("4");
            ...
            obj = new Static("sta00","10","0","196","30",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("용어 사전");
            obj.set_cssclass("sta_WF_FrmTitle");
            this.addChild(obj.name, obj);

            obj = new Button("btn00","118","5","158","39",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("btn00");
            this.addChild(obj.name, obj);
            // Layout Functions
        ...
        */
        ...
        this.btn00_onclick = function(obj,e)
        {
        	...
        	objApp.gdsWord.lookup("WORD", objApp.gdsWord.getColumn(objApp.gdsWord.rowposition, "WORD", "KO"));  // word의 컬럼이 내가 선택한 컬럼의 word와 같으면 ko컬럼을 가져오겠다.


        	trace(this.gfnGetWord(objApp.gdsWord.lookup("WORD", objApp.gdsWord.getColumn(objApp.gdsWord.rowposition, "WORD", "EN"))));
