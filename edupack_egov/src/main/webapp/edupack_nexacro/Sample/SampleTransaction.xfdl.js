(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grdList","10","156",null,null,"10","10",null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Div("divSearch","10","55",null,"53","10",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("");
            obj.set_cssclass("div_WF_Area");
            this.addChild(obj.name, obj);

            obj = new Button("btnSearch",null,"10","60","28","11",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("조회");
            ...
            obj = new Edit("edtId","72","10","157","28",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edtName","319","10","157","28",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("Static01","19","10","44","28",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("ID");
            obj.set_cssclass("sta_WF_SearchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("Static00","247","10","64","28",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("NAME");
            obj.set_cssclass("sta_WF_SearchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Button("btnAdd",null,"123","53","28","482",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("입력");
            obj.getSetter("uWord").set("insert");
            this.addChild(obj.name, obj);

            obj = new Button("btnDel",null,"123","53","28","424",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("삭제");
            obj.getSetter("uWord").set("delete");
            this.addChild(obj.name, obj);

            obj = new Button("btnSave",null,"123","53","28","366",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("저장");
            obj.getSetter("uWord").set("save");
            this.addChild(obj.name, obj);

            obj = new Button("btnExcelEx",null,"123","100","28","115",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("excel export");
            this.addChild(obj.name, obj);

            obj = new Button("btnExcelImport",null,"123","100","28","10",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("excel import");
            this.addChild(obj.name, obj);

            obj = new Button("btnExcelTitle",null,"123","140","28","221",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("excel export(title)");
            this.addChild(obj.name, obj);

            obj = new Button("btnGridSize","10","123","220","28",null,null,null,null,null,null,this);
            obj.set_taborder("8");
