(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnLine","10","114","80","28",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("Line");
            this.addChild(obj.name, obj);

            obj = new Button("btnBar","95","114","80","28",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Bar");
            this.addChild(obj.name, obj);

            obj = new Button("btnPie","265","114","80","28",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("Pie");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"Month\"/><Cell col=\"1\" text=\"Vancouver\"/><Cell col=\"2\" text=\"Toronto\"/></Band><Band id=\"body\"><Cell text=\"bind:Month\"/><Cell col=\"1\" text=\"bind:Vancouver\"/><Cell col=\"2\" text=\"bind:Toronto\" textAlign=\"right\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Button("btnLine00","370","114","120","28",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("Line - Multi");
            this.addChild(obj.name, obj);

            obj = new Button("btnBar00","495","114","120","28",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("Bar - Multi");
            this.addChild(obj.name, obj);

            obj = new Button("btnColumn","180","114","80","28",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("Column");
            this.addChild(obj.name, obj);

            obj = new Button("btnColumn00","620","114","120","28",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("Column - Multi");
            this.addChild(obj.name, obj);

            obj = new Button("btnCombination","765","114","230","28",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            ...
            obj = new Static("sta02","10","0","251","30",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("rMate 챠트(웹브라우져 방식)");
            obj.set_cssclass("sta_WF_FrmTitle");
            this.addChild(obj.name, obj);

            obj = new Static("sta03","10","50",null,"50","10",null,"980",null,null,null,this);
            obj.set_taborder("11");
