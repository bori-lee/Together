(function()
{
    return function()
    {
        ...
        {
            this.set_name("listClass");
            this.set_titletext("모임 목록조회");
            if (Form == this.constructor)
            {
                this._setFormPosition(1280,1220);
            }
            ...
            obj = new Edit("edtCateg","20","Static01:2","168","50",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_font("20pt/normal \"휴먼모음T\"");
            obj.set_textAlign("left");
            obj.set_background("white");
            obj.set_border("0px none black");
            obj.set_color("black");
            obj.set_text("카테고리명");
            this.addChild(obj.name, obj);

            obj = new Div("divMain","Static01:-650","130","1280","870",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("");
            obj.set_border("0px none");
            this.addChild(obj.name, obj);

            obj = new Div("divPage00","Static01:-579","divMain:37","1138","63",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("");
            ...
            obj = new Combo("cboLocation","cboCondition:-290","50","134","40",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            ...
            obj = new Static("staExist","40","120","602","117",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("* 해당 카테고리의 모임이 존재하지 않습니다. ");
            obj.set_font("15pt/normal \"휴먼모음T\"");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Div("divbottom","0","1160",null,"60","0",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("");
            obj.set_border("0px none");
            ...
            //-- Default Layout : this
            obj = new Layout("default","",1280,1220,this,function(p){});
        ...
        */
        ...
        this.listClass_onload = function(obj,e)
        {
        	this.cboLocation.set_value("0");
        	this.cboCondition.set_value("a");

        	trace("관심지역 value=" + this.cboLocation.value);
        	trace("컨디션 value =" + this.cboCondition.value);

        	var fvCategNo = nexacro.getApplication().gvCategNo;

        	if(fvCategNo == 1)
        	{
        		this.edtCateg.set_value("운동/스포츠");
        	}else if(fvCategNo == 2){
        		this.edtCateg.set_value("외국/언어");
        	}else if(fvCategNo == 3){
        		this.edtCateg.set_value("음악/악기/댄스");
        	}else if(fvCategNo == 4){
        		this.edtCateg.set_value("아웃도어/여행");
        	}else if(fvCategNo == 5){
        		this.edtCateg.set_value("야구관람");
        	}else if(fvCategNo == 6){
        		this.edtCateg.set_value("사교/인맥");
        	}
        ...
        */
        ...
        {
        	if(trId == "listClass"){
        		trace("데이터"+this.dsClass.getRowCount());
        		if(this.dsClass.rowcount < 1){
        			this.staExist.set_visible(true);
        			// 				var objSearchDiv = new Div();  //내가 만들려고하는 오브젝트, 그리드를 만들고싶으면 new grid(); 콤보도 마찬가지로 표현..
        			// 				objSearchDiv.init("divSearch", 309, 18, 231, 92); // 컴포넌트에 대한 초기값, (아이디, left, top, width, height)
        			// 				objSearchDiv.set_border("1px solid black");  // 배경색깔
        			// 				objSearchDiv.set_text("검색 결과 없음");
        			// 				objSearchDiv.show();  // 화면에보여줄려고 하는 메소드 show
        		}else{
        ...
        */
        this.fnPageInit = function () // 페이징처리 기본 세팅값
        {
        	...
        	//trace("listClass===" + nexacro.getApplication().gvCategNo);
        ...
        */
        this.fvInsert = function()
        {
        	...
        	for(var i=0; i<this.dsClass.getRowCount(); i++)
        	{
        		...
        		objStatic2.init("sta2", 10, 295, 300, 35);
        		...
        		objStatic2.set_font("bold 11pt/normal, Berlin Sans FB");
        ...
        */
        ...
        /**
        * @description 이미지 클릭 시, 해당 이미지의 모임상세 페이지로 이동하는 폼 함수
        */
        ...
        **************************************************************************/
        /**
        * @description 콤보가 변경된 후 발생하는 이벤트
        */
        ...
        */
        ...
        {
            this.addEventHandler("onload",this.listClass_onload,this);
        ...
        this.loadIncludeScript("listClass.xfdl");
