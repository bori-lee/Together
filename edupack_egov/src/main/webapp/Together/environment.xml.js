if (nexacro.Environment)
{
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("Service0", "form", "./Service0/", "session", null, "", "0", "0");
        nexacro._addService("Together", "form", "./Together/", "dynamic", null, "", "0", "0");
        nexacro._addService("Cmm", "form", "./Cmm/", "dynamic", null, "", "0", "0");
        nexacro._addService("SvcUrl", "JSP", "http://172.10.14.142:8088/edupack_egov/", "none", null, "", "0", "0");
        nexacro._addService("ExtJs", "js", "./nexacrolib/component/ExtJs/", "dynamic", null, "", "0", "0");
        nexacro._addService("ExtJs_Together", "js", "./nexacrolib/component/ExtJs_Together/", "dynamic", null, "", "0", "0");
        nexacro._addService("XPushUrl", "file", "./XPushUrl/", "session", null, "", "0", "0");
        nexacro._addService("SvcUrl3", "JSP", "http://172.10.14.142:8088/edupack_egov/edu/XPUSH/", "session", null, "", "0", "0");
